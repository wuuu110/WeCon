...
def get_random_problems(batch_size, problem_size,device = None,generator = None):
    #problems = torch.rand(size=(batch_size, problem_size, 4),device=device,generator=generator)
